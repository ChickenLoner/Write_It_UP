...
# Pattern to search for: The old relative path
# Note: The pattern is r'...' for raw string, and dots are escaped.
# It finds: ../../_resources/
SEARCH_PATTERN = r'\.\./\.\./' + re.escape(OLD_FOLDER_NAME) + r'/'

# Replacement text: The new absolute path from the website root
...
def rename_folder():
    ...
    try:
        ...
        # If 'git' is not available in the path, this will fall back to os.rename
